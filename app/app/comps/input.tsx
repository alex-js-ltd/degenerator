...
const inputVariants = cva(undefined, {
	variants: {
		variant: {
			...
			pool: 'disabled:pointer-events-none inline-flex h-8 w-full items-center gap-1.5 rounded-md bg-gray-800 hover:bg-gray-700/70 hover:text-gray-100 text-sm px-2 transition-colors whitespace-nowrap focus:outline-none leading-relaxed text-white shadow-none outline-none ring-0 [scroll-padding-block:0.75rem] selection:bg-teal-300 selection:text-black placeholder:text-zinc-400 border border-gray-800 disabled:bg-gray-900 disabled:border disabled:border-white disabled:border-opacity-[0.125] py-3 pl-8',
		},
	},
	defaultVariants: {
		variant: 'default',

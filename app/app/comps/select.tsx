...
function Select({
	...
	return (
		<div className="relative w-32 pl-2">
			<Input
				name={meta.name}
			...
			>
				...
				<RadixSelect.Portal>
					<RadixSelect.Content
						...
						side="bottom"
						sideOffset={20}
						className="overflow-hidden bg-gray-900 rounded-md z-10 w-fit min-w-[124px] h-auto max-h-[136px] data-[state=open]:animate-scale-in-95 data-[state=closed]:animate-scale-out-95"
						{...contentProps}
					>
